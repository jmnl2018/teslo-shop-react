...
export const ProductForm = ({ title, subTitle, product, onSubmit, isPending }: Props) => {
    ...
    const {
        ...
        defaultValues: product //El formulario debe respetar la informacion que tiene el tipo producto
    });
    ...
    const currectStock = watch('stock');
    ...
    const addTag = () => {
        ...
        setValue('tags', Array.from(newTagSet)) //Usamos Array.from para convertir el Set sizeSet a Array
    };
    ...
    const addSize = (size: Size) => {
        ...
        setValue('sizes', Array.from(sizeSet)) //Usamos Array.from para convertir el Set sizeSet a Array
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        {...register('slug', {
                                            required: true,
                                            /* Con esto !/\s/.test(value) verifica que no haya espacios*/
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                    ...
                                    <span
                                        className={`px-2 py-1 text-xs font-medium rounded-full ${currectStock > 5
