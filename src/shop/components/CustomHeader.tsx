...
export const CustomHeader = () => {
    ...
    const isAdminValid = user?.roles?.includes('admin') ?? false;

    const { gender } = useParams(); //Lee lo que va despues del : configurado en el approuter
    ...
    const handleSearch = (event: KeyboardEvent<HTMLInputElement>) => {
        ...
        if (!query) {
            ...
            newSearchParams.set('query', inputRef.current!.value) // El signo ! le dices al recat que confie y que nunca sera nulo
        }
