...
export const RegisterPage = () => {
    ...
    const handleRegister = async (event: FormEvent<HTMLFormElement>) => {
        ...
        // es decir previene la propagacion del formulario
        event.preventDefault();

        setIsPosting(true);


        //Con esto FormData tiene tos los names que se hayan puesto
        ...
        try {
            ...
            const message = error?.response?.data?.message ?? 'Revise los datos';
            toast.error(message);
        }
